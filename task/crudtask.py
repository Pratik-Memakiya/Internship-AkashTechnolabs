...
try:
    ...
    mysqldb=mysql.connector.connect(host="localhost",user="root",password="root",database="crud")
mycursor = mysqldb.cursor()
try:
    mycursor.execute("create table student(id INT primary key AUTO_INCREMENT,name VARCHAR(255), marks INT)")
except:
